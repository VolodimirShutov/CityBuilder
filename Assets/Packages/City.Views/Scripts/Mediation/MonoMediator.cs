...
{
    public abstract class MonoMediator : MonoBehaviour, IMediator
    {
    ...
    public abstract class MonoMediator<TView> : MonoMediator, IMediator<TView>
        where TView : Component, IView
    {
        ...
        {
            Debug.Log($"Injected {View.GetType().Name} with {(visitors == null ? visitors.Length : 0)} visitors");
            _visitors = visitors;
        }
